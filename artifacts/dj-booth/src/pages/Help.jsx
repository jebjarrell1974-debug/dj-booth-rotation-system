  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: 'If the entertainer is on a separate device (phone) outside the same Wi-Fi as the booth, they\'ll need to enter the booth\'s IP address on the login screen. Tap "Set Booth IP" and enter the IP of the booth computer. Once set, it\'s remembered on that device.'
      },
      {
        heading: 'Auto-Logout',

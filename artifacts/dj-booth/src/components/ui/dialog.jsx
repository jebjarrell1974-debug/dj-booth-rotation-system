...
// Taps on the on-screen keyboard (rendered outside the dialog portal) must not
// count as "outside" interactions, or the dialog closes on the first keystroke.
const isVirtualKeyboardEvent = (event) => {

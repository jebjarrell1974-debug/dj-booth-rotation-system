...
// Radix AlertDialog.Content doesn't type the outside-dismiss handlers (alert
// dialogs are modal-only), but the underlying Dialog.Content still fires them —
// so we accept and guard them explicitly for virtual-keyboard safety.

...
Type=Application
Name=DJ Booth Kiosk
Exec=bash -c "sleep 15 && chromium --kiosk --noerrdialogs --disable-infobars --force-device-scale-factor=0.94 --autoplay-policy=no-user-gesture-required --disable-background-media-suspend --disable-features=BackgroundMediaSuspend,MediaSessionService --disable-session-crashed-bubble http://localhost:3001"
...
Exec=bash -c "chromium --kiosk --noerrdialogs --disable-infobars --force-device-scale-factor=0.94 --autoplay-policy=no-user-gesture-required --disable-background-media-suspend --disable-features=BackgroundMediaSuspend,MediaSessionService --disable-session-crashed-bubble http://localhost:3001"
Terminal=false
Categories=Audio;
DEOF

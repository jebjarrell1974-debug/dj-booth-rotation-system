...
const sourceFiles = [
  'artifacts/dj-booth/public/public/djbooth-update-github.sh',
  'artifacts/dj-booth/public/public/djbooth-watchdog.sh',
];
...
const msg = 'fix(kiosk): use --app + window-position + wmctrl (Chromium --kiosk Linux ignores window-position)';
